...
export const EN: Record<string, string> = {
  ...
  'Receta en PDF (opcional)': 'Recipe PDF (optional)',
  'Enlace de Drive, Dropbox…': 'Drive, Dropbox… link',
  'Tiene que ser un enlace que empiece por https://': 'It has to be a link starting with https://',
  'Ver receta': 'See recipe',
  'Ver la receta': 'See the recipe',
  'Receta': 'Recipe',
  'Guardado': 'Saved',
  'No se pudo guardar la descripción': 'Could not save the description',
  ...
  'Cómo apunta el alumno su esfuerzo': 'How the athlete logs their effort',
  'Intensidad de cada rutina': 'Intensity of each routine',
  'Qué pones en cada ejercicio': 'What you set on each exercise',
  'Además de series y repeticiones. Si lo dejas vacío en un ejercicio, el alumno no ve nada en ese.':
    'On top of sets and reps. Leave it empty on an exercise and the athlete sees nothing there.',
  'Cómo se llama': 'What it is called',
  'Nada': 'None',
  'La intensidad': 'The intensity',
  'Guardar también como plantilla': 'Also save as template',
  'Sin variable por ejercicio': 'No per-exercise variable',
  'Intensidad en %': 'Intensity in %',
  'RIR': 'RIR',
  'La mía': 'Mine',
